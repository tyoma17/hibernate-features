package com.tyoma17.hibernate.entity_graph.annotations;

import com.tyoma17.hibernate.entity_graph.annotations.entity.*;
...
class EntityGraphViaAnnotationsTest {
    ...
    void viaJpaApi() {
        ...
        try {
            ...
            persons = entityManager.createQuery("FROM Person", Person.class)
                    .setHint("javax.persistence.fetchgraph", entityManager.getEntityGraph("personsDogs"))
                    .getResultList();
